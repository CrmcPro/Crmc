    ...
    <div class="bg-slate-100">
        <section class="h-screen flex center items-center justify-center">
          <div class="text-gray-800 w-2/5 h-3/5 bg-white rounded-2xl text-center">
            ...
            <div class="pt-4 text-sm font-semibold	"><h2>Veuillez vous connecter pour continuer</h2></div>
              ...
              <div class="">
                <form>
                  ...
                  <div class=" pb-3 pt-8">
                    ...
                    <button
                      type="button"
                      class=" px-56 py-4 border border-sky-600	 rounded text-sm  text-cyan-600 "
                      @click="Singup"
                    >
                      Inscription
                    </button>
