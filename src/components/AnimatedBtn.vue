...
<div class="px-4  ">
  ...
  <span class="relative border-b-2 border-[#1873a8] ">Envoyer</span><i class=" absolute px-2  "> <font-awesome-icon   icon="fa-circle-down" /></i>
</div>
</span>
<!-- <span class="absolute bottom-0 right-0 w-full h-12 -mb-1 -mr-1 transition-all duration-200 ease-linear bg-[#1873a8] rounded-lg group-hover:mb-0 group-hover:mr-0" data-rounded="rounded-lg"></span> -->
</a>
